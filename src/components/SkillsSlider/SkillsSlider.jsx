...
export default function SkillsSlider() {
  ...
  let technicalSkills = [
    ...
    },
    {
      ...
      description: 'A React-based framework for building fast, SEO-friendly web apps with server-side rendering and static generation.',
      uaDescription: 'Фреймворк на основі React для створення швидких веб-додатків із серверним рендерингом та статичною генерацією.',
      frDescription: 'Un framework basé sur React pour créer des apps web rapides avec rendu côté serveur et génération statique.',
      firstTried: '22.03.2025'
    },
    {
      name: 'Stripe',
      icon: '/technologies/stripe.svg',
      techType: 'Payment System',
      description: 'A payment platform for easy online payments, subscriptions, and global transactions with clean developer tools.',
      uaDescription: 'Платіжна платформа для легких онлайн-платежів, підписок і глобальних транзакцій з простими інструментами для розробників.',
      frDescription: 'Une plateforme de paiement pour gérer les paiements en ligne, les abonnements et les transactions avec de bons outils développeur.',
      firstTried: '10.05.2025'
    },
    {
      name: 'Telegram Web',
      icon: '/technologies/telegram.svg',
      techType: 'Messaging Platform / Mini App Integration',
      description: 'A web-based version of Telegram that supports messaging, bot interactions, and mini app integration for smooth user experiences.',
      uaDescription: 'Веб-версія Telegram, що підтримує повідомлення, взаємодію з ботами та інтеграцію мінізастосунків.',
      frDescription: 'Une version web de Telegram prenant en charge la messagerie, les bots et l’intégration de mini-apps pour une expérience fluide.',
      firstTried: '17.05.2025'
    },
    {
      name: 'TypeScript',
      icon: '/technologies/typeScript.svg',
      techType: 'Programming Language',
      description: 'A statically typed superset of JavaScript that adds optional types, enhancing code quality, maintainability, and developer productivity.',
